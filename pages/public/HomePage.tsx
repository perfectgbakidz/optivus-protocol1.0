          ...
          <section className="w-full py-20 md:py-32">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="text-center">
                  <p className="text-lg text-brand-light-gray mb-4">
                  ...
                  <div className="mt-8 inline-flex flex-col gap-4">
                    <div className="bg-white text-black font-semibold py-3 px-6 rounded-lg shadow-lg">
                      $OPTI is our Store of Value Powered by OPTIVision
                    </div>
                    <Button 
        ...
        <section className="bg-white py-16 md:py-24">
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 items-center">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-bold text-brand-dark leading-tight">Bringing Ideas to Life</h2>
                    </div>
                    <div className="text-center md:text-left">
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Optivus Protocol: The Smarter Way to Earn. Stake, refer, and grow with $OPTI — the next-generation asset for passive income and long-term value.
                    </p>
                    </div>
                </div>
            </div>
        ...
        <section className="bg-brand-dark py-16 md:py-24">
            <div className="container mx-auto px-6">
                <div className="text-left mb-12">
                    <h2 className="text-4xl lg:text-5xl font-bold text-white">OPTIVision</h2>
