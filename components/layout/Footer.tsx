      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-center text-brand-light-gray flex justify-center items-center space-x-2">
          ...
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-brand-secondary" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 1.75L11.5 2.5 6 12.25 12 16l6-3.75-5.5-9.75L12 1.75zM12 17.25l-6-3.75L12 22.25l6-6.25-6 3.75z" />
            </svg>
